...
// .wrangler/tmp/pages-5puWHo/functionsWorker-0.9506863196674775.mjs
...
async function onRequestGet3({ params, env }) {
  ...
  const stat = /* @__PURE__ */ __name2((v, label) => '<div class="stat"><b>' + escapeHtml(v) + "</b><span>" + label + "</span></div>", "stat");
...
// .wrangler/tmp/bundle-DiOkYF/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-DiOkYF/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9506863196674775.js.map
